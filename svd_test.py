...
MODEL_PATH = os.path.join(MODEL_SVD_SAVE_DIR, "svd_model.pt")
TEST_CSV_PATH = os.path.join(putanja,"data", "forTest_svd1.csv")
...
test_df.to_csv("forTest_with_predictions_svd101.csv", index=False)
...
ndcg_at_5 = calculate_ndcg_at_k("forTest_with_predictions_svd101.csv", k=5)
